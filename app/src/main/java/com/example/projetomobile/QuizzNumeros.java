...
public class QuizzNumeros extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quizz_numeros);
        ...
        btnVoltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(QuizzNumeros.this, TelaQuizzes.class));
            }
        });
    }
