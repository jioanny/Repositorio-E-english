...
public class QuizzComidas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quizz_comidas);
        ...
        btnVoltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(QuizzComidas.this, TelaQuizzes.class));
            }
        });
    }
